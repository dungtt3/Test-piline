...
namespace Eaap.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260724022133_Phase4_Enterprise")]
    partial class Phase4_Enterprise
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Eaap.Domain.Entities.ApiToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Eaap.Domain.Entities.NotificationChannel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Eaap.Domain.Entities.NotificationDeliveryLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Eaap.Domain.Entities.TrendPoint", b =>
                {
                    ...
                    b.Property<int>("DebtTotalMinutes")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Eaap.Domain.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Eaap.Domain.Entities.UserRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Eaap.Domain.Entities.ApiToken", b =>
                {
                    b.HasOne("Eaap.Domain.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Eaap.Domain.Entities.NotificationDeliveryLog", b =>
                {
                    b.HasOne("Eaap.Domain.Entities.NotificationChannel", "Channel")
                        .WithMany()
